...
namespace Kaki_AssetBundleBuilder
{
    public static class ScriptableObjectCreator
    {
        ...
        public static void ShowDialog<T>(string defaultDestinationPath, Action<T> onScritpableObjectCreated = null,Action<IEnumerable<Type>> SelectionConfirmed = null)
            where T : ScriptableObject
        {
            var selector = new ScriptableObjectSelector<T>(defaultDestinationPath, onScritpableObjectCreated,SelectionConfirmed);
        ...
        private class ScriptableObjectSelector<T> : OdinSelector<Type> where T : ScriptableObject
        {
            ...
            }public ScriptableObjectSelector(string defaultDestinationPath, Action<T> onScritpableObjectCreated = null,Action<IEnumerable<Type>> SelectionConfirmed = null)
            {
                this.onScritpableObjectCreated = onScritpableObjectCreated;
                this.defaultDestinationPath = defaultDestinationPath;
